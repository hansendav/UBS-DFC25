...
class Trainer(object): 
    def __init__(self, args): 
        ...
        self.model = UNetPlusLoc(in_channels=4, n_classes=4, n_siren=1)
        ...
        self.train_iou_classes.to(self.device)
        ...
        self.train_iou_all.to(self.device)
        ...
        self.val_iou_classes.to(self.device)
        ...
        self.val_iou_all.to(self.device)
    ...
    def training(self): 
        ...
        for batch_idx, (img_stacks, targets, coords) in enumerate(pbar_train):
            ...
            if (self.iter) % 10 == 0: 
                ...
                mean_cl_loss = mean_cl_loss / 10
                segm_loss = segm_loss / 10
